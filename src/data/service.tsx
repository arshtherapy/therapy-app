export const servicesData = [
  ...
  },
  {
    ...
    benefits: [
      ...
      "Prompt speech methods to target individual sounds and clearity"
    ],
    conditions: [
  ...
  },
  {
    ...
    benefits: [
      ...
      "Enhance overall developmental outcomes and maximize a child's potential",
      "Improve long-term progress and quality of life",
      "Implement sensory and reflex-based therapeutic techniques"
    ],
    conditions: [
      "Developmental Delays",
      "Autism",
  ...
  },
  {
    ...
    description: "Individualized educational programs tailored to meet the unique needs of children with disabilities.",
    icon: "📚",
  ...
  {
    id: "school-readiness-group-program",
